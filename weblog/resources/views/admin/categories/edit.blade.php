                ...
                <div class="contact-form">
                    <form action="/adminpanel/categories/{{$category->id}}" method="post">
                        ...
                        <div class="form-group">
                            <input type="text" name="title" class="form-control" placeholder="دسته بندی را وارد کنید" value="{{$category->title}}"/>
                        </div>

                        <div><button class="btn" name="submit" type="submit">ویرایش</button></div>
                    </form>
